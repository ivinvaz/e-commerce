...
export async function GET(
  ...
  { params }: { params: { id: string } }
    ...
    try {
        ...
        const product = await prisma.tB_PRODUTO.findUnique({
            where: {
                SQ_PRODUTO: productId,
            }
        });
...
export async function PUT(
  ...
  { params }: { params: { id: string } }
    ...
    try {
        ...
        if (isNaN(productId) || (!NO_PRODUTO && ST_PRODUTO === undefined)) {
            return NextResponse.json(
        ...
        const updatedProduct = await prisma.tB_PRODUTO.update({
            where: {
                SQ_PRODUTO: productId,
            },
            data: {
                NO_PRODUTO: NO_PRODUTO || undefined,
                ST_PRODUTO: ST_PRODUTO || undefined,
            },
        });
...
export async function DELETE(
  ...
  { params }: { params: { id: string } }
    ...
    try {
        ...
        await prisma.tB_PRODUTO.delete({
            where: {
                SQ_PRODUTO: productId,
            },
        });
