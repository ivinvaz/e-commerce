...
export async function GET(
  ...
  { params }: { params: { id: string } }
    ...
    try {
        ...
        const product = await prisma.tB_CATEGORIA_PRODUTO.findUnique({
            where: {
                SQ_CATEGORIA_PRODUTO: productId,
            },
        });
...
export async function PUT(
  ...
  { params }: { params: { id: string } }
    ...
    try {
        ...
        const updatedProduct = await prisma.tB_CATEGORIA_PRODUTO.update({
            where: {
                SQ_CATEGORIA_PRODUTO: productId,
            },
            data: {
...
export async function DELETE(
  ...
  { params }: { params: { id: string } }
    ...
    try {
        ...
        await prisma.tB_CATEGORIA_PRODUTO.delete({
            where: {
                SQ_CATEGORIA_PRODUTO: productId,
            },
        });
